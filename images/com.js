var commentusername = ["ready", "Halime", "SONOSMANLI", "AHMETCAN", "KerimSever", "FenerliCock", "AyLin Kara", "hileci90", "Marilena", "EMRE :D", "JOHNYSINSREYIZ", "Mesane", "Cococops", "KralHaydar234", "Venq", "KafaPatlatan", "Selioo", "LOLCUCOCUK", "Ermes", "Calvin", "cccANILccc", "", "200000", "400000", "600000", "800000", "1000000", "1000000", "1000000", "1000000", "1000000", "1000000", "1000000", "Elmas", "! ", ". ", "...", " ", "Lann", "Teşekkürler ", "krall ", "bu kodumun hilesi bi harika ", "hile çalışıyor üstelik bedava gerçekten", "yemin ederim hile calisti parada almadi ", "hile legalmi ", "calisiyormu ki denemedim ", "denemek lazım ", "hile icin sagol admin kanka", "SONUNDA BI HILE CALISTI AMK", "HILE MIKEMMEL ", "NE KADAR TESEKKUR ETSEM AZ ", " ", " ", " ", "", " ", "", "", "", "", "", "", "harikasın kardesim sagol ", "bro kral adamsın ", "baba sen ne yaptın ya ", "aman bu açığı sakın kapatmasınlar ", "Tsk bro!!!! ", "gözerlime inanamıyorum lan xd", " tesekkurler, calismicak sandim ama calisti ", "para alacak sandim ama ücretsizmiş ", "sagol Admin..  ", "sagolasin !! ", "", "", "", "", "", "", "", "", "", "", "", "", " ", " ", " ", " ", "  ", " ", "", "", "", "", "CALISTI LAAN COK MUTLUYUMM ", "EYVALLAH ", "UCRETSIZ MI?  ", "HILE UCRETSIZ HARBI HERKESE TESEKKURLER ", " ", " ", " ", "Tesekur ederim", "Thank youuuuu!", "COK SAGOL", "Cok tesekkurler", "Eyvallah", "tsk ederim", "tesekkurler", "sagol ", "sdafsdsadf ", "<3 ", ":))) ", "XD ", ":D ", "<3<3 ", "xd ", ":)", "commented", "state-disabled", "addClass", "#commentUsernameLabel", "disabled", "attr", "#commentUsername", "#commentCommentLabel", "#commentComment", "comment1Cookie", "username1Cookie", "username2Cookie", "username3Cookie", "timePosted11Cookie", "timePosted22Cookie", "timePosted33Cookie", "comment2Cookie", "comment3Cookie", "click", "#commentSubmit", "random", "floor", "join", "length", "html", "#username", " ", "#comment", "#timePosted", "Biraz önce", "1 dk", "", " dk", "round", "val", "state-error", "getTime", "setTime", "; expires=", "toGMTString", "cookie", "=", "; path=/", ";", "split", "substring", "charAt", "indexOf"];
