  ...
  $.fn.extend({
		...
		$( '.packages li' ).click( function() {
			...
			$( '.homePage' ).fadeOut( function() {
				...
				setTimeout( function() {
					...
					$( '.console-text' ).html( 'Sunucuya bağlanılıyor...' );
									...
									setTimeout( function() {
										...
										setTimeout( function() {
											...
											setTimeout( function() {
												...
												$( '.console-text' ).html( 'Kontrol ediliyor...' );

												$( '.ui-progressbar-value' ).css( 'width', '25%' );

												setTimeout( function() {

													$( '.console-text' ).html( 'Yükleniyor...' );

													$( '.ui-progressbar-value' ).css( 'width', '30%' );

													setTimeout( function() {

														$( '.console-text' ).html( 'Oyuncu aranıyor...' );

														$( '.ui-progressbar-value' ).css( 'width', '35%' );

														setTimeout( function() {

															$( '.console-text' ).html( 'Oyuncu Bulundu!' );

															$( '.ui-progressbar-value' ).css( 'width', '40%' );

															setTimeout( function() {

																$( '.console-text' ).html( 'Bağlantı kurulmaya çalışılıyor...' );

																$( '.ui-progressbar-value' ).css( 'width', '48%' );

																setTimeout( function() {

																	$( '.console-text' ).html( 'Bağlandı!' );

																	$( '.ui-progressbar-value' ).css( 'width', '50%' );

																	setTimeout( function() {

																		$( '.console-text' ).html( 'Modüller yükleniyor 20/20!' );

																		$( '.ui-progressbar-value' ).css( 'width', '60%' );

																		setTimeout( function() {

																			$( '.console-text' ).html( 'Sunucu bekleniyor...' );

																			$( '.ui-progressbar-value' ).css( 'width', '70%' );

																			setTimeout( function() {

																				$( '.console-text' ).html( 'Elmaslar yükleniyor...' );
   ...
   //-----------------------------[ Btn Generate ]-----------------------------------
	...
	$( '.verifyBtn' ).click( function() {
		...
		window.location.href = "https://bynobot.click/a/s379e996211/552?s1=";
